                ...
                <div class="form-row mb-4">
                    ...
                    <div class="form-group col-md-2">
                        <select name="sorting" class="form-control">
                            <option value="{{ SortType::LATEST }}" @if($sorting === SortType::LATEST) selected @endif>投稿日時が新しい順</option>
                            <option value="{{ SortType::OLDEST }}" @if($sorting === SortType::OLDEST) selected @endif>投稿日時が古い順</option>
                            <option value="{{ SortType::NICE_DESC }}" @if($sorting === SortType::NICE_DESC) selected @endif>いいねが多い順</option>
                        </select>
                    </div>
                </div>
            </form>
